    ...
    <div className="min-h-screen bg-[#050505] text-white font-sans pb-32 relative overflow-hidden selection:bg-indigo-500/30 selection:text-white">
      ...
      <div className="bg-black/40 backdrop-blur-3xl px-8 py-8 flex items-center justify-between sticky top-0 z-40 border-b border-white/5">
        <div className="flex items-center gap-6">
          ...
          <div>
            <h1 className="text-2xl font-display font-black tracking-tighter text-white">DEPOSIT PROTOCOL</h1>
            <p className="text-[10px] font-black text-white/30 uppercase tracking-[0.3em]">Institutional Liquidity Injection</p>
          </div>
        </div>
      ...
      <div className="p-8 relative z-10 max-w-4xl mx-auto mt-12">
          ...
          {step === 1 && (
            ...
            >
              ...
              <div className="lg:col-span-2 space-y-10">
                <div>
                  <h2 className="text-5xl font-display font-black tracking-tighter leading-[0.9] mb-6">
                    ADD <br />
                    <span className="text-white/30">CAPITAL</span> <br />
                    NOW.
                  </h2>
                  <p className="text-white/40 font-medium leading-relaxed">
                    Inject liquidity into your institutional account to begin high-yield protocol operations.
                  </p>
                </div>
              ...
              <div className="lg:col-span-3 space-y-8">
                ...
                <section className="bg-white/5 border border-white/10 rounded-[3.5rem] p-10 backdrop-blur-3xl relative overflow-hidden">
                  <div className="flex justify-between items-center mb-10">
                    <h3 className="text-[10px] font-black text-white/30 uppercase tracking-[0.3em]">Protocol Gateway</h3>
                ...
                {/* Enter Amount */}
                <section className="bg-white/5 border border-white/10 rounded-[3.5rem] p-10 backdrop-blur-3xl relative overflow-hidden">
                  <h3 className="text-[10px] font-black text-white/30 mb-10 uppercase tracking-[0.3em]">Liquidity Amount</h3>
                  <div className="relative mb-10 group">
                    <span className="absolute left-8 top-1/2 -translate-y-1/2 text-white/20 font-display font-black text-3xl group-focus-within:text-indigo-500 transition-colors">Rs.</span>
                    <input
                      type="number"
                      value={amount}
                      onChange={(e) => setAmount(e.target.value)}
                      placeholder="0.00"
                      className="w-full pl-24 pr-10 py-8 bg-white/5 border border-white/10 rounded-[2.5rem] text-5xl font-display font-black text-white focus:outline-none focus:border-indigo-500/50 focus:ring-8 focus:ring-indigo-500/10 transition-all placeholder:text-white/5 tracking-tighter"
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    {PRESETS.map((p) => (
                      <button
                        ...
                        className="py-5 bg-white/5 border border-white/10 rounded-2xl text-[10px] font-black text-white/40 hover:bg-white hover:text-black hover:border-white transition-all active:scale-95 uppercase tracking-[0.2em]"
                      >
                        {p.toLocaleString()}
                      </button>
                    ))}
          ...
          {step === 2 && (
            ...
            >
              ...
              <div className="lg:col-span-2 space-y-8">
                <div className="bg-gradient-to-br from-indigo-600 to-violet-800 rounded-[4rem] p-12 text-center relative overflow-hidden shadow-2xl shadow-indigo-900/40">
                  ...
                  <p className="text-indigo-100/60 text-[10px] font-black uppercase tracking-[0.3em] mb-4">Injection Amount</p>
                  <h2 className="text-7xl font-display font-black text-white mb-10 tracking-tighter">
                    {Number(amount).toLocaleString()} <span className="text-xl font-medium opacity-40 uppercase tracking-widest">PKR</span>
                  </h2>
                  
                  <div className="inline-flex items-center gap-6 bg-black/20 backdrop-blur-3xl px-10 py-5 rounded-[2.5rem] border border-white/10">
                    <div className="w-10 h-10 bg-white rounded-2xl p-2 flex items-center justify-center">
                ...
                <div className="bg-white/5 border border-white/10 rounded-[3rem] p-10 backdrop-blur-3xl">
                  <h3 className="text-[10px] font-black text-white/30 mb-8 uppercase tracking-[0.3em]">Protocol Instructions</h3>
                  <ul className="space-y-6">
                    {[
                      ...
                      'Upload the screenshot to verify the injection.'
                    ].map((text, i) => (
              ...
              <div className="lg:col-span-3 space-y-8">
                ...
                <div className="bg-white/5 border border-white/10 rounded-[3.5rem] p-12 backdrop-blur-3xl">
                  <h3 className="text-[10px] font-black text-white/30 mb-10 uppercase tracking-[0.3em]">Gateway Credentials</h3>
                  
                  <div className="space-y-10">
                    {method.id === 'bank' && (
                      <div className="group">
                        <p className="text-[9px] font-black text-white/20 uppercase tracking-[0.3em] mb-4 ml-4">Bank Institution</p>
                        <div className="bg-white/5 p-8 rounded-[2rem] border border-white/10 group-hover:bg-white/10 transition-all">
                          <p className="text-xl font-black text-white tracking-tight">{(method as any).bankName}</p>
                        </div>
                      </div>
                    )}
                    
                    <div className="group">
                      <p className="text-[9px] font-black text-white/20 uppercase tracking-[0.3em] mb-4 ml-4">Beneficiary Name</p>
                      <div className="bg-white/5 p-8 rounded-[2rem] border border-white/10 group-hover:bg-white/10 transition-all">
                        <p className="text-xl font-black text-white tracking-tight">{method.title}</p>
                      </div>
                    </div>
                    
                    <div className="group">
                      <p className="text-[9px] font-black text-white/20 uppercase tracking-[0.3em] mb-4 ml-4">Account Identifier</p>
                      <div className="flex items-center gap-4">
                        <div className="flex-1 bg-white/5 p-8 rounded-[2rem] border border-white/10 group-hover:bg-white/10 transition-all">
                          <p className="text-2xl font-display font-black text-white tracking-widest">{method.account}</p>
                        </div>
                        <button
                          onClick={() => copyToClipboard(method.account)}
                          className="w-20 h-20 bg-indigo-600 hover:bg-indigo-500 text-white rounded-[2rem] flex items-center justify-center transition-all active:scale-90 shadow-2xl shadow-indigo-900/40 group/btn"
                        >
                ...
                <div className="bg-white/5 border border-white/10 rounded-[3.5rem] p-12 backdrop-blur-3xl">
                  <div className="flex items-center gap-4 mb-10">
                    ...
                    <h3 className="text-[10px] font-black text-white/30 uppercase tracking-[0.3em]">Protocol Verification</h3>
                  </div>
                  
                  <label className="flex flex-col items-center justify-center w-full h-72 border-2 border-dashed border-white/10 hover:border-indigo-500/50 hover:bg-white/5 rounded-[3rem] cursor-pointer transition-all group relative overflow-hidden">
                    {screenshot ? (
                      <div className="flex flex-col items-center justify-center p-10 text-center">
                        <div className="w-24 h-24 bg-emerald-500/10 rounded-[2rem] flex items-center justify-center mb-6 text-emerald-400 border border-emerald-500/20 shadow-2xl shadow-emerald-900/20">
                          <CheckCircle2 size={48} strokeWidth={3} />
                        </div>
                        <p className="text-lg font-black text-white truncate max-w-[300px] tracking-tight">
                          {screenshot.name}
                        </p>
                      ...
                      <div className="flex flex-col items-center justify-center p-10 text-center">
                        <div className="w-24 h-24 bg-white/5 rounded-[2rem] flex items-center justify-center mb-8 text-white/10 group-hover:bg-indigo-500/10 group-hover:text-indigo-400 transition-all duration-700 border border-white/5 group-hover:border-indigo-500/20">
                          <Upload size={48} strokeWidth={2.5} />
                        </div>
                        <p className="text-lg font-black text-white/60 uppercase tracking-[0.2em]">
                          Drop Receipt
                        </p>
                        <p className="text-[10px] font-black text-white/20 uppercase tracking-[0.3em] mt-4">Max Payload: 5MB</p>
                      </div>
                    )}
                ...
                <button
                  ...
                  className="w-full py-8 bg-white text-black hover:bg-indigo-600 hover:text-white disabled:bg-white/5 disabled:text-white/10 rounded-[2.5rem] font-black text-lg uppercase tracking-[0.3em] transition-all shadow-2xl shadow-white/5 hover:-translate-y-2 active:scale-95 flex items-center justify-center gap-4"
                >
                  {loading ? (
                    <div className="w-8 h-8 border-4 border-black/20 border-t-black rounded-full animate-spin"></div>
                  ) : (
                    <>Finalize Injection <CheckCircle2 size={20} /></>
                  )}
                </button>
              </div>
            </motion.div>
          ...
          >
            ...
            >
              ...
              <p className="text-lg text-white/40 mb-12 leading-relaxed font-medium">
                Your deposit of <span className="text-white font-black">{Number(amount).toLocaleString()} PKR</span> has been queued for verification. Protocol clearance usually takes 2-6 hours.
              </p>
              ...
              >
                {loading ? (uploadProgress > 0 ? "TRANSMITTING..." : "PROCESSING...") : "RETURN TO TERMINAL"}
              </button>
            </motion.div>
          </motion.div>
        )}
